...
BLOG_AUTHOR = "Spec-S5"  # (translatable)
BLOG_TITLE = "Spec-S5"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.spec-s5.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "no-reply@spec-s5.org"
BLOG_DESCRIPTION = "Spec-S5"  # (translatable)
...
LOGO_URL = '/files/SpecS5logo.001.jpeg'
...
<a href="https://gitlab.com/noirlab/public/spec-S5">Source</a> |
